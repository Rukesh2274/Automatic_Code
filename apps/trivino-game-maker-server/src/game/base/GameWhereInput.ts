...
import { GameConfigurationListRelationFilter } from "../../gameConfiguration/base/GameConfigurationListRelationFilter";
...
class GameWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => GameConfigurationListRelationFilter,
  })
  @ValidateNested()
  @Type(() => GameConfigurationListRelationFilter)
  @IsOptional()
  @Field(() => GameConfigurationListRelationFilter, {
    nullable: true,
  })
